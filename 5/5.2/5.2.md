...
**Semántica**:  
Representa los distintos estados posibles en los que puede encontrarse una solicitud de cierre de ventas. Su función es controlar y clasificar el flujo de aprobación o rechazo del proceso, permitiendo una trazabilidad clara del avance de cada solicitud.

| Atributo                 | Tipo       | Formato | Valores Válidos               | Unidad | Derivada de | Semántica                                                                 | Ontología                                                                 |
|--------------------------|------------|---------|--------------------------------|--------|-------------|---------------------------------------------------------------------------|---------------------------------------------------------------------------|
| cod_estado_solicitud   | INT        |         | TAB ESTADO_SOLICITUD    | ----   | --          | Código que identifica el estado actual de una solicitud.                 | Control del ciclo de vida de la solicitud (pendiente, aprobada, rechazada). |
| nombre_estado_solicitud| CHAR(15)   |         | **NO NULO**                    | ----   | --          | Nombre legible del estado asociado al código.                            | Facilita la comprensión del estado por parte del usuario.                |
...
**Semántica**:  
Registra cada petición formal de cierre de una venta tras la firma del contrato. Representa el punto de partida del módulo de Cierre de Ventas y contiene los datos necesarios para validar el acuerdo y continuar con la ejecución.

| Atributo                   | Tipo          | Formato       | Valores Válidos               | Unidad | Derivada de | Semántica                                                                 | Ontología                                                                 |
|----------------------------|---------------|---------------|--------------------------------|--------|-------------|---------------------------------------------------------------------------|---------------------------------------------------------------------------|
| id_solicitud             | INT           |               | **NO NULO**                    | ----   | --          | Identificador único de la solicitud.                                      | Clave primaria. Referencia de cada cierre de venta.                      |
| descripcion_solicitud    | VARCHAR(250)  |               | **NO NULO**                    | ----   | --          | Breve resumen o detalle de la solicitud.                                  | Documenta el propósito del cierre.                                       |
| id_cliente               | INT           |               | **NO NULO**                    | ----   | --          | Código del cliente asociado.                                             | Relación directa con la entidad "cliente".                               |
| fecha_solicitud          | DATE          | `AAAA/MM/DD`  | Válido en el calendario        | --     | --          | Fecha de creación de la solicitud.                                        | Marca el inicio del proceso de cierre de venta.                          |
| fecha_firma              | DATE          | `AAAA/MM/DD`  | Válido en el calendario        | --     | --          | Fecha en la que se firma la solicitud.                                    | Determina el paso de validación de firma.                                |
| cod_estado_solicitud    | INT           |               |  TAB ESTADO_SOLICITUD    | ----   | --          | Estado actual de la solicitud.                                            | Permite controlar la evolución del proceso.                              |
