...
# Tablas de Calificación de Oportunidades
...
| **Atributo**             | **Naturaleza (tipo de valor)** | **Formato** | **Valores válidos**             | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                            | **Ontología (rol en el negocio)**                                             |
|--------------------------|--------------------------------|-------------|----------------------------------|------------|-----------------|---------------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| id_dolor                 | INT                            | ---         | Número entero positivo           | ----       | --              | Identificador único para cada dolor registrado.                                        | Representa el problema del cliente que se está analizando en ventas.           |
...
| id_cliente               | INT                            | ---         | Número entero positivo           | ----       | --              | Identificador único del cliente asociado al dolor.                                     | Relaciona el dolor con un cliente específico, esencial para el seguimiento.    |
| id_ejecutivo_comercial   | INT                            | ---         | Número entero positivo           | ----       | --              | Identificador del ejecutivo comercial asignado.                                        | Asocia al ejecutivo con la gestión de la oportunidad de venta.                 |
| cod_sector               | CHAR                           | ---         | Número entero positivo           | ----       | --              | Sector económico al que pertenece el dolor.                                           | Clasifica al dolor según la solución que se quiera aplicar.                    |
| id_visita                | INT                            | ---         | Número entero positivo           | ----       | --              | Identificador único de la visita asociada al dolor o necesidad.                       | Relaciona el dolor con una visita realizada al cliente para su análisis.      |

---

## Decisor

**Semantica**: Representa al cliente o representante de la empresa que tiene la autoridad para tomar decisiones clave dentro de la organización en relación con la aceptación o rechazo de las soluciones propuestas por la empresa.

| **Atributo**         | **Naturaleza (tipo de valor)** | **Formato**  | **Valores válidos**  | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                            | **Ontología (rol en el negocio)**                                                      |
|----------------------|--------------------------------|--------------|----------------------|------------|-----------------|---------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| id_decisor             | INT                            | ---       | Número entero positivo            | ----       | --              | Identificador único del decisor.                                                       | Identificación del cliente con poder de decisión                                        |
| nombre_decisor      | CHAR                           | X(15)        | NO NULO              | ----       | --              | Nombre completo del decisor.                                                            | Identificación personal del decisor.                                                   |
| telefono_decisor    | INT                            | 999999999    | 9 DIGITOS            | ----       | --              | Teléfono de contacto del decisor.                                                      | Canal de comunicación directa.                                                         |
| correo_decisor      | VARCHAR                        | X*@X*X*      | Autenticación         | ----       | --              | Correo electrónico del decisor.                                                         | Canal de comunicación digital.                                                         |
...
| RUC_decisor         | INT                            | 9999999999   | 10 DIGITOS           | ----       | --              | Número de RUC del decisor, identificación fiscal.                                       | Identificación legal del decisor.                                                      |
| cargo_decisor       | INT                           | 9        | TAB CATALOGO_CARGO             | ----       | --              | Cargo del decisor dentro de la empresa.                                                 | Rol que define su autoridad para tomar decisiones.                                     |
| direccion_decisor   | VARCHAR                        | X(20)        | NO NULO              | ----       | --              | Dirección del decisor.                                                                  | Ubicación física para contacto o visitas.                                              |
...
| **Atributo**         | **Naturaleza (tipo de valor)** | **Formato**    | **Valores válidos**     | **Unidad**  | **Derivada de** | **Semántica (descripción)**                                                                 | **Ontología (rol en el negocio)**                                                          |
|----------------------|--------------------------------|----------------|-------------------------|------------|-----------------|------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| id_convocatoria         | INT                            | ---         | Número entero positivo               | ----       | --              | Identificador único de la convocatoria.                                                        | Permite rastrear y asociar cada convocatoria a un proceso específico.                       |
| id_dolor               | INT                            | ---         | Número entero positivo               | ----       | --              | Identificador del dolor o necesidad asociada.                                                  | Relaciona la convocatoria con el dolor o necesidad identificado previamente.                 |
...
| **Atributo**        | **Naturaleza (tipo de valor)** | **Formato** | **Valores válidos**  | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                               | **Ontología (rol en el negocio)**                                                      |
|---------------------|--------------------------------|-------------|----------------------|------------|-----------------|------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------|
| id_viabilidad          | INT                            | ---      | Número entero positivo            | ----       | --              | Identificador único para cada evaluación de viabilidad técnica.                          | Permite rastrear y asociar la evaluación técnica a cada oportunidad.                   |
| id_dolor               | INT                            | ---       | Número entero positivo            | ----       | --              | Identificador del dolor o necesidad asociado a la evaluación técnica.                    | Relaciona la viabilidad técnica con el dolor o necesidad que se está evaluando.        |
...
| **Atributo**          | **Naturaleza (tipo de valor)** | **Formato** | **Valores válidos**  | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                               | **Ontología (rol en el negocio)**                                                       |
|-----------------------|--------------------------------|-------------|----------------------|------------|-----------------|------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| id_partner              | INT                            | ---       | Número entero positivo            | ----       | --              | Identificador único del partner en el sistema                                              | Permite asociar a un partner con proyectos y oportunidades comerciales.                 |
| nombre_partner      | CHAR                           | X(25)       | NO NULO              | ----       | --              | Nombre del partner o empresa asociada                                                      | Ayuda a identificar y diferenciar a cada socio comercial.                               |
| telefono_partner    | INT                            | 999999999   | 9 DIGITOS            | ----       | --              | Número telefónico del partner para contacto                                                | Facilita la comunicación directa y el seguimiento de proyectos con el partner.         |
| correo_partner      | VARCHAR                        | X*@X*X*     | Autenticación         | ----       | --              | Dirección de correo electrónico del partner                                                | Se utiliza para la correspondencia formal y la gestión de documentación relevante.      |
| id_dolor                | INT                            | ---       | Número entero positivo            | ----       | --              | Identificador asociado a una necesidad o "dolor" que el partner ayuda a resolver.          | Relaciona al partner con una necesidad específica del cliente, facilitando la asignación de recursos. |

---

## Contacto_Partner

**Semantica:** Representa los contactos clave dentro de la organización de los clientes o socios comerciales con los cuales la empresa interactúa regularmente.

| **Atributo**        | **Naturaleza (tipo de valor)** | **Formato**   | **Valores válidos**          | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                        | **Ontología (rol en el negocio)**                                               |
|---------------------|--------------------------------|---------------|------------------------------|------------|-----------------|-----------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| cod_contacto        | INT                            | ---         |                     |            |                 | Identificador único del contacto                                                   | Representa un identificador único para cada contacto registrado                |
| nombre_contacto     | CHAR                           | X(20)        | No nulo                      |            |                 | Nombre completo del contacto                                                      | Define quién es el contacto dentro de la organización                           |
| telefono_contacto   | CHAR                           | 999999999         | Números de teléfono          |            |                 | Número de teléfono del contacto                                                   | Facilita la comunicación telefónica con el contacto                             |
| correo_contacto     | VARCHAR                           | X(20)        | Direcciones válidas de correo electrónico |            |                 | Correo electrónico del contacto                                                   | Permite la comunicación vía email                                                |
| cargo_contacto           | INT                            | 9        | TAB CATALOGO_CARGO                    |            |                 | Relaciona al contacto con un cargo específico dentro de la empresa                 | Define el rol del contacto dentro de la empresa, facilitando la segmentación de la comunicación |


## Dolor_equipo_tecnico

**Semántica:** Representa la asignación de un equipo técnico específico a un dolor o necesidad del cliente.

| **Atributo**       | **Naturaleza (tipo de valor)** | **Formato** | **Valores válidos**  | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                               | **Ontología (rol en el negocio)**                                                       |
|--------------------|--------------------------------|-------------|----------------------|------------|-----------------|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| id_equipo             | INT                            | ---       | Número entero positivo            | ----       | --              | Identificador único del equipo técnico asociado al dolor.                                 | Permite asociar a un equipo técnico específico con un dolor o necesidad del cliente.     |
| id_dolor              | INT                            | ---       | Número entero positivo           | ----       | --              | Identificador del dolor o necesidad relacionado con el equipo.                           | Relaciona el dolor o necesidad del cliente con el equipo técnico encargado de la solución. |
...
| **Atributo**         | **Naturaleza (tipo de valor)** | **Formato**  | **Valores válidos**  | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                            | **Ontología (rol en el negocio)**                                             |
|----------------------|--------------------------------|--------------|----------------------|------------|-----------------|---------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
| id_usuario             | INT                            | ---       | Número entero positivo            | --         | --              | Identificador único del usuario del sistema                                           | Relaciona al ejecutivo con la cuenta del sistema                               |
| id_ejecutivo_comercial | INT                            | ---       | Número entero positivo            | ----       | --              | Identificador único del ejecutivo comercial                                           | Actor responsable de gestionar el cierre de ventas y contacto inicial          |
...
| etapa_propuesta      | CHAR                       | X             | TAB ETAPA_PROPUESTA     | ---    | ---         | Etapa de la propuesta vigente en la negociación| Control de estado en el proceso |
...
| comentarios      | TEXT                    | ---      | NO NULO                | ---    | ---         | Comentarios del cliente                   | Información textual para seguimiento     |
