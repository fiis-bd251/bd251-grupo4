...
|------------------------|-----------------------------|-------------|---------------------------|--------|-------------|-----------------------------------------------|--------------------------------------------------------------|
| reunion             | INT                         | ---         | Número entero positivo    | ---    | ---         | Identificador único de la reunión             | Clave primaria que identifica cada reunión                   |
...
| sector              | CHAR                           | X         | TAB SECTOR           | ----       | --              | Sector económico que clasifica el tipo de negocio o industria al que pertenece el dolor. | Facilita la categorización del dolor según el área de negocio, permitiendo enfocar la solución en el sector adecuado.                    |
| visita              | INT                            | XXXXX       | 5 DIGITOS            | ----       | --              | Identificador único de la visita asociada al dolor o necesidad del cliente.              | Relaciona el dolor con una visita realizada al cliente para su análisis.      |
...
| **Atributo**         | **Naturaleza (tipo de valor)** | **Formato**  | **Valores válidos**  | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                            | **Ontología (rol en el negocio)**                                                      |
|----------------------|--------------------------------|--------------|----------------------|------------|-----------------|---------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| decisor             | INT                            | XXXXX        | 5 DIGITOS            | ----       | --              | Identificador único del decisor.                                                       | Identificación del cliente con poder de decisión                                        |
...
| cargo_decisor       | CHAR                           | X(15)        | NO NULO              | ----       | --              | Cargo del decisor dentro de la empresa.                                                 | Rol que define su autoridad para tomar decisiones.                                     |
...
| estado_propuesta      | CHAR                       | XX            | TAB ESTADO_PROPUESTA    | ---    | ---         | Estado actual de la propuesta                  | CInforma a los interesados sobre el progreso de la negociación.|
| etapa_propuesta      | CHAR                       | X             | TAB ESTAPA_PROPUESTA    | ---    | ---         | Etapa de la propuesta vigente en la negociación| Control de estado en el proceso                 |
...
| horas         | INT                        | XX        | NO NULO              | ---    | ---         | Horas asignadas al recurso             | Planificación operativa del trabajo |
