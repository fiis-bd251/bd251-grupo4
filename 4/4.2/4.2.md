...
| Atributo              | Naturaleza (tipo de valor) | Formato     | Valores válidos        | Unidad | Derivada de | Semántica (descripción)                             | Ontología (rol en el negocio)                                |
|-----------------------|----------------------------|-------------|-------------------------|--------|--------------|-----------------------------------------------------|--------------------------------------------------------------|
| id_usuario            | CHAR                       | XXXXX       | 5 valores alfanuméricos| –      | –            | Identificador único del usuario del sistema         | Relaciona al ejecutivo con la cuenta del sistema             |
| id_ejecutivo_comercial| CHAR                       | XXXXXX      | 6 valores alfanuméricos| –      | –            | Identificador único del ejecutivo comercial         | Actor responsable de gestionar el cierre de ventas           |
...
| Atributo                | Naturaleza (tipo de valor) | Formato  | Valores válidos      | Unidad | Derivada de | Semántica (descripción)                                                                 | Ontología (rol en el negocio)                                               |
|------------------------|----------------------------|----------|-----------------------|--------|--------------|-----------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| id_dolor               | CHAR                       | XXXXX    | 5 valores alfanuméricos | ----   | --           | Identificador único para cada dolor registrado.                                        | Representa el problema del cliente que se está analizando en ventas.        |
...
| id_cliente             | CHAR                       | XXXXX    | 5 valores alfanuméricos | ----   | --           | Identificador único del cliente asociado al dolor.                                     | Relaciona el dolor con un cliente específico, esencial para el seguimiento. |
| id_ejecutivo_comercial| CHAR                       | XXXXXX   | 6 valores alfanuméricos | ----   | --           | Identificador del ejecutivo comercial asignado.                                        | Asocia al ejecutivo con la gestión de la oportunidad de venta.              |
...
| Atributo         | Naturaleza (tipo de valor) | Formato     | Valores válidos         | Unidad | Derivada de | Semántica (descripción)                                                        | Ontología (rol en el negocio)                                    |
|------------------|----------------------------|-------------|--------------------------|--------|--------------|--------------------------------------------------------------------------------|-------------------------------------------------------------------|
| id_convocatoria  | CHAR                       | XXXXXX      | 7 valores alfanuméricos  | ----   | --           | Identificador único de la convocatoria.                                       | Permite rastrear y asociar cada convocatoria a un proceso específico. |
| id_dolor         | CHAR                       | XXXXX       | 5 valores alfanuméricos  | ----   | --           | Identificador del dolor o necesidad asociada.                                 | Relaciona la convocatoria con el dolor o necesidad identificado. |
...
| Atributo      | Naturaleza (tipo de valor) | Formato     | Valores válidos         | Unidad | Derivada de | Semántica (descripción)                                               | Ontología (rol en el negocio)                                     |
|---------------|----------------------------|-------------|--------------------------|--------|--------------|------------------------------------------------------------------------|--------------------------------------------------------------------|
| id_viabilidad | CHAR                       | XXXXX       | 6 valores alfanuméricos  | ----   | --           | Identificador único para cada evaluación técnica.                     | Permite rastrear la evaluación técnica de cada oportunidad.       |
...
| **Atributo**   | **Naturaleza (tipo de valor)** | **Formato**    | **Valores válidos**          | **Unidad** | **Derivada de** | **Semántica (descripción)**                                                                 | **Ontología (rol en el negocio)**                                                       |
|----------------|--------------------------------|----------------|------------------------------|------------|-----------------|------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| id_partner     | CHAR                           | XXXXX          | 5 valores alfanumericos       | ----       | --              | Identificador único del partner en el sistema                                                    | Permite asociar a un partner con proyectos y oportunidades comerciales.                  |
...
| Atributo     | Naturaleza (tipo de valor) | Formato     | Valores válidos         | Unidad | Derivada de | Semántica (descripción)                                                    | Ontología (rol en el negocio)                                      |
|--------------|----------------------------|-------------|--------------------------|--------|--------------|----------------------------------------------------------------------------|---------------------------------------------------------------------|
| id_equipo    | CHAR                       | XXXXX       | 5 valores alfanuméricos  | ----   | --           | Identificador único del equipo técnico.                                   | Identifica el equipo técnico responsable de una oportunidad.       |
...
| id_cliente   | CHAR                       | XXXXX       | 5 valores alfanuméricos  | ----   | --           | Identificador del cliente asociado.                                       | Relaciona al cliente con el equipo técnico asignado.              |
...
| Atributo        | Naturaleza (tipo de valor) | Formato     | Valores válidos         | Unidad | Derivada de | Semántica (descripción)                                                        | Ontología (rol en el negocio)                                                |
|------------------|----------------------------|-------------|--------------------------|--------|--------------|--------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| id_equipo        | CHAR                       | XXXXX       | 5 valores alfanuméricos  | ----   | --           | Identificador único del equipo técnico.                                       | Asocia un equipo técnico específico al dolor o necesidad del cliente.        |
| id_dolor         | CHAR                       | XXXXX       | 5 valores alfanuméricos  | ----   | --           | Identificador del dolor relacionado.                                          | Relaciona el dolor del cliente con el equipo encargado de la solución.       |
