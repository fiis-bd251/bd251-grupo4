...
## Tabla: solicitud_estado
**Semántica:** Estados posibles de una solicitud de cierre de ventas

| Atributo | Naturaleza | Formato | Valores válidos | Unidad | Derivada de | Descripción | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-------------|-----------|
| estado_solicitud | INT | SX | TAB ESTADO_SOLICITUD | -- | -- | Código estado actual | Control ciclo de vida |
| nombre_estado_solicitud | CHAR | X(15) | NO NULO | -- | -- | Nombre legible del estado | Comprensión usuario |
...
## Tabla: solicitud
**Semántica:** Petición formal de cierre de venta post-firma

| Atributo | Naturaleza | Formato | Valores válidos | Unidad | Derivada de | Descripción | Ontología |
|----------|------------|---------|-----------------|--------|-------------|-------------|-----------|
| solicitud | INT | 999999 | NO NULO | -- | -- | ID único solicitud | Clave primaria |
| descripcion_solicitud | VARCHAR | X(250) | NO NULO | -- | -- | Resumen/detalle solicitud | Documentación propósito |
| cliente | INT | 999999 | NO NULO | -- | -- | Cliente asociado | Relación entidad cliente |
| fecha_solicitud | DATE | AAAA-MM-DD | <= hoy | -- | -- | Fecha creación | Inicio proceso |
| fecha_firma | DATE | AAAA-MM-DD | >= fecha_solicitud | -- | -- | Fecha firma | Validación formal |
| estado_solicitud | INT | SX | TAB ESTADO_SOLICITUD | -- | -- | Estado actual | Control evolución proceso |
