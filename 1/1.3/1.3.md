...
## Actividades del Proceso: Generación de Propuestas (Mejorado)

Se genera una propuesta técnica a partir de los requerimientos, el alcance y la información validada. La solución se ajusta de forma iterativa mediante reuniones de integración entre áreas y se elabora un presupuesto basado en tarifas de recursos. Finalmente, se presenta la propuesta al cliente para su revisión, y, en función de la respuesta, se avanza a la fase de Negociación y Contratos o se documenta el cierre en el CRM.

## Actividades del Proceso: Generación de Propuestas
...
| 5   | Evaluar Beneficios y Viabilidad                         | Analizar y cuantificar los beneficios operativos y técnicos de la solución, verificando su viabilidad de acuerdo a los requerimientos del cliente.                                                                                         | Área Técnica                                     |
| 6   | Calcular y Presentar ROI                                | Determinar el Retorno sobre la Inversión (ROI) utilizando tarifas y datos predefinidos, documentando los resultados que respalden la propuesta.                                                                                             | Área Administrativa                              |
| 7   | Elaborar Presupuesto Detallado                          | Desglosar los costos del proyecto considerando tarifas, recursos y tiempos estimados, generando un presupuesto integral y ajustado a la solución propuesta.                                                                               | Área Administrativa                              |
| 8   | Aprobación Interna del Presupuesto y Ajustes            | Someter el presupuesto a revisión interna. Si se requieren modificaciones, realizarlas y volver a presentar hasta obtener la aprobación.                                                                                                   | Área Administrativa                              |
| 9   | Revisión Conjunta de Propuesta Global                   | Validar de forma integral la propuesta (solución técnica, ROI y presupuesto) en una sesión conjunta entre las áreas Técnica, Administrativa y Comercial.                                                                                   | Área Técnica, Administrativa y Comercial         |
| 10  | Preparar Material de Presentación                       | Consolidar la propuesta final en un formato de presentación (documento, diapositivas, etc.), destacando de forma clara la solución, el ROI y el presupuesto.                                                                              | Área Comercial                                   |
| 11  | Coordinar Reunión con el Cliente                        | Organizar y agendar la reunión para la presentación de la propuesta, definiendo la agenda y la logística del encuentro.                                                                                                                     | Área Comercial                                   |
| 12  | Presentar Propuesta al Cliente                          | Exponer la solución, el ROI y el presupuesto detallado, recopilando la retroalimentación inicial del cliente durante la reunión.                                                                                                             | Área Comercial                                   |
| 13  | Evaluar Respuesta del Cliente                           | Analizar la respuesta del cliente para identificar si existen objeciones o si la propuesta es aceptada positivamente.                                                                                                                     | Área Comercial                                   |
| 14  | Abordar Objeciones y Aclarar Dudas                        | Gestionar y resolver las objeciones o dudas planteadas por el cliente. En esta etapa, el Área Técnica interviene para ajustar aspectos técnicos, mientras que el Área Comercial coordina la respuesta.                               | Área Comercial y Área Técnica                    |
| 15  | Documentar Respuesta y, Iniciar Negociación o Cerrar Proceso | Según la respuesta del cliente: <br>- Si existe interés positivo, iniciar la negociación para formalizar el acuerdo. <br>- Si no hay interés, documentar la respuesta en el CRM y cerrar el proceso.                           | Área Comercial (con apoyo de Técnica y Administrativa) |
