...
![DiagramaValidacion de requisitos](https://github.com/fiis-bd251/bd251-grupo4/blob/main/imagenes/DIAGRAMA-PROPUESTAS.png)

| Nro | Actividad                                               | Descripción                                                                                                                                                                                                                                | Responsable                                       |
|-----|---------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------|
| 1   | Elaborar Prepropuesta Técnica                           | Redactar un borrador inicial que detalle la solución técnica, integrando los requerimientos y el alcance definidos.                                                                                                                        | **Equipo Técnico**                                |
| 2   | Revisión Interna y Ajustes Iterativos                   | Revisar por pares la prepropuesta y realizar los ajustes necesarios. Si se identifican observaciones, se itera el proceso hasta alcanzar los estándares internos.                                                                      | **Equipo Técnico**                                |
| 3   | Reunión de Integración Técnica y Administrativa         | Coordinar una sesión conjunta para validar de manera integral los aspectos técnicos y financieros del borrador, unificando criterios entre las áreas involucradas.                                                                      | **Equipo Técnico y Gerente Comercial**            |
| 4   | Realizar Ajustes Posteriores a la Integración           | Incorporar las observaciones surgidas de la reunión de integración, afinando la propuesta con las correcciones pertinentes.                                                                                                                 | **Equipo Técnico**                                |
| 5   | Calcular y Presentar ROI                                | Determinar el Retorno sobre la Inversión (ROI) utilizando tarifas y datos predefinidos, documentando los resultados que respalden la propuesta.                                                                                             | **Gerente Comercial**                             |
| 6   | Elaborar Presupuesto Detallado                          | Desglosar los costos del proyecto considerando tarifas, recursos y tiempos estimados, generando un presupuesto integral y ajustado a la solución propuesta.                                                                               | **Gerente Comercial**                             |
| 7   | Aprobación Interna del Presupuesto y Ajustes            | Someter el presupuesto a revisión interna. Si se requieren modificaciones, realizarlas y volver a presentar hasta obtener la aprobación.                                                                                                   | **Gerente Comercial**                             |
| 8   | Preparar Material de Presentación                       | Consolidar la propuesta final en un formato de presentación (documento, diapositivas, etc.), destacando de forma clara la solución, el ROI y el presupuesto.                                                                              | **Ejecutivo Comercial**                           |
| 9   | Coordinar Reunión con el Cliente                        | Organizar y agendar la reunión para la presentación de la propuesta, definiendo la agenda y la logística del encuentro.                                                                                                                     | **Ejecutivo Comercial**                           |
| 10  | Presentar Propuesta al Cliente                          | Exponer la solución, el ROI y el presupuesto detallado, recopilando la retroalimentación inicial del cliente durante la reunión.                                                                                                             | **Ejecutivo Comercial**                           |
| 11  | Abordar Objeciones y Aclarar Dudas                        | Gestionar y resolver las objeciones o dudas planteadas por el cliente. En esta etapa, el **Equipo Técnico** interviene para ajustar aspectos técnicos, mientras que el **Ejecutivo Comercial** coordina la respuesta y registra formalmente las respuestas, acuerdos y compromisos en el CRM. | **Ejecutivo Comercial y Equipo Técnico**          |
| 13  | Evaluar Respuesta del Cliente                           | Según la respuesta del cliente: <br>- Si existe interés positivo, iniciar la negociación para formalizar el acuerdo.<br>- Si no hay interés, documentar la respuesta en el CRM y cerrar el proceso.                           | **Ejecutivo Comercial**                           |
...
![Diagrama Negociación](../../imagenes/Diagrama_Negociacion.png)
 ...
 | Nro | Actividad | Descripción | Responsable |
  ---|-----------|-------------|------------------|
 | 1 | **Visualización de Negociaciones** | Exposición detallada de la solución técnica, beneficios y condiciones generales al cliente | Ejecutivo Comercial|
 ...
 | 6 | **Agenda reunion con cliente** | Coordinar con el cliente una reunion para discutir los terminos de la negociación | Ejecutivo Comercial |
 | 7 | **Solicitar Elaboración de contrato** | Solicitar al personal del area administrativa la elaboración y revision legal del contrato | Ejecutivo Comercial |
 | 8 | **Elaboración de Contrato** | Redacción del documento legal que formaliza los acuerdos alcanzados | Area Administrativa |
 | 9 | **Revisión Legal** | Análisis de implicaciones legales, validación de cláusulas y términos contractuales | Area Administrativa |
 | 1o | **Ajustes Contractuales** | Modificaciones al contrato basadas en observaciones del departamento legal o negociaciones finales | Ejecutivo Comercial |
 | 11 | **Firma de Contrato** | Formalización del acuerdo mediante la firma de todas las partes involucradas | Ejecutivo Comercial |
 | 12 | **Documentación** | Remisión de la parte contractual con todas las aclaraciones establecidas | Area Administrativa |
