...
| **Flow of Events**               | 1. Al validarse la OC, el sistema crea el proyecto.<br>2. El coordinador asigna el equipo técnico.<br>3. Se genera el acta de inicio.<br>4. Se registra un seguimiento con fechas comprometidas. |
